  ...
  function syncCvContent() {
    ...
    if (experience) {
      ...
      if (list) list.innerHTML = `
        ...
        <article class="classic-item"><div class="classic-date">2024 – Sep 2026</div><div><h3>Graduate Lecturer — Sorbonne Paris Nord University</h3><p>Teach NLP, Knowledge Graphs, Machine Learning and Deep Learning courses.</p></div></article>
        ...
        <article class="classic-item"><div class="classic-date">2009 – 2013</div><div><h3>Earlier Experience — Industrial Engineering & Marketing</h3><p>Earlier roles across industrial engineering and marketing.</p></div></article>`;
